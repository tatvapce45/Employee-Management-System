...
namespace EmployeeManagementSystem.DataAccess.Repositories.Interfaces
{
    public interface IGenericRepository<T> where T : class
    {
        ...
        Task<PagedResult<T>> GetAsync(int pageNumber,int pageSize,string sortBy,string sortOrder,string searchTerm,Expression<Func<T, bool>>? filter = null,Expression<Func<T, object>>[]? includes = null,params Expression<Func<T, string>>[] searchProperties);
